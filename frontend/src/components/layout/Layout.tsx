...
const Layout: React.FC = () => {
                ...
                toast((t) => (
                    <div className="flex items-center gap-4 py-1">
                        <div className="flex-1">
                            ...
                            <p className="text-[11px] text-slate-300 leading-tight">Welcome to the platform! Please fill in your basic details (Phone, University, GPA, Year, Skills) to unlock all features.</p>
                        </div>
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-color)] relative overflow-hidden font-sans selection:bg-purple-500/30 transition-colors duration-500">
            ...
            {/* Main Content - Smooth margin transition to prevent right-side clipping */}
            <div 
                className={`pt-16 relative z-10 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${isSidebarExpanded ? 'ml-64' : 'ml-20'}`}
            >
