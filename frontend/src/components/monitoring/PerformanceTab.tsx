                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            <div className="relative w-40 h-40">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    <span className="text-4xl font-bold text-gray-800">{Math.round(performance.overall_performance_score)}</span>
                                ...
                                {[
                                    ...
                                    <div key={metric.label} className="bg-gray-50 rounded-xl p-4">
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span className="text-lg font-bold text-gray-800">{Math.round(metric.value)}%</span>
                                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card padding="lg">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-2xl font-bold text-gray-800">{performance.dropout_risk} Risk</p>
                                    <p className="text-sm text-gray-500">Score: {Math.round(performance.dropout_risk_score)}%</p>
                                </div>
                            </div>
                        </Card>
                        <Card padding="lg">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-2xl font-bold text-gray-800">{Math.round(performance.promotion_probability)}%</p>
                                    <p className="text-sm text-gray-500">Full-Time Readiness</p>
                                </div>
                            </div>
                        </Card>
                    </div>
