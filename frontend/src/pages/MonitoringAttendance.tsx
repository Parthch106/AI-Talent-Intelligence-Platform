...
import { Card, AttendanceHeatmap, Modal, Button, CustomSelect } from '../components/common';
                    ...
                    <div className="flex flex-wrap items-center gap-6 w-full xl:w-auto">
                        {(user?.role === 'ADMIN' || user?.role === 'MANAGER') && (
                            <div className="relative z-30">
                                ...
                                {showInternDropdown && (
                                    <div className="absolute top-full right-0 mt-3 w-[350px] bg-[var(--bg-color)] backdrop-blur-3xl border border-[var(--border-color)] rounded-2xl shadow-2xl z-[9999] overflow-hidden animate-scale-in">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <CustomSelect
                                ...
                                onChange={(v) => setAttendanceForm({ ...attendanceForm, status: v })}
                                accent="purple"
                            />
                        </div>
                    </div>
