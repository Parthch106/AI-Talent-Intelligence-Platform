    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <Modal
                ...
                onClose={() => { setShowBulkUploadModal(false); setBulkUploadFile(null); }}
                ...
                <div className="space-y-6">
                    <div className="bg-[var(--bg-muted)] rounded-xl p-4 border border-[var(--border-color)]">
                        ...
                        <div className="mb-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                            <h5 className="text-xs font-semibold text-blue-400 mb-2 flex items-center gap-1">
                    ...
                    <div className="flex gap-3 pt-4 border-t border-[var(--border-color)]">
                        <Button
                            variant="ghost"
                            onClick={() => { setShowBulkUploadModal(false); setBulkUploadFile(null); }}
                                ...
                                <div className="ml-auto flex gap-2">
                                    ...
                                    {user?.role === 'ADMIN' && (
                                        <Button
                                            size="sm"
                                            variant="outline"
                                            onClick={() => handleDeleteIntern(selectedIntern.user.id)}
