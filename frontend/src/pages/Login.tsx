            ...
            <div className="relative z-10 w-full max-w-md mx-4 animate-fade-in">
                ...
                <div className="relative glass-card p-8 rounded-2xl border border-white/10 backdrop-blur-xl bg-slate-900/50">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center gap-2 cursor-pointer group">
                                <input type="checkbox" className="w-4 h-4 rounded border-slate-600 bg-slate-800 text-purple-500 focus:ring-purple-500/50 cursor-pointer" />
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <button className="flex items-center justify-center py-3 px-4 rounded-xl bg-slate-800/50 border border-slate-700 hover:border-slate-600 hover:bg-slate-800 transition-all duration-300 group">
