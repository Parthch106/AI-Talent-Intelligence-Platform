...
const AnalysisPage: React.FC = () => {
    ...
    // Job role state — matches platform department names
    ...
    const [jobRoles] = useState<string[]>(DEPARTMENT_ROLES);
    const [selectedJobRole, setSelectedJobRole] = useState<string>(DEPARTMENT_ROLES[0]);
            ...
            {loading ? (
                    ...
                    <Card className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <CustomSelect
                                    options={[
                                        { value: '', label: 'Select department role...', disabled: true },
                                        ...jobRoles.map(role => ({ value: role, label: role }))
                                    ]}
                ...
                <Card className="text-center py-12">
                    ...
                    <div className="max-w-xs mx-auto mb-4">
                        ...
                        <CustomSelect
                            options={[
                                { value: '', label: 'Choose a department role...', disabled: true },
                                ...jobRoles.map(role => ({ value: role, label: role }))
                            ]}
                            value={selectedJobRole}
                            onChange={setSelectedJobRole}
