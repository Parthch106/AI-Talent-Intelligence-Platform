...
from .views import (
    ...
    DepartmentListView, ManagerManagementViewSet, BulkUploadAdminsView
)
...
router.register(r'managers', ManagerManagementViewSet, basename='manager-management')

urlpatterns = [
    path("managers/bulk-upload/", BulkUploadAdminsView.as_view(), name="bulk-upload-admins"),
