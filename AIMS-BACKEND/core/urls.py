...
from core.media_views import MediaUploadView, S3HealthCheckView
...
urlpatterns = [
    ...
    # AWS S3 — generic file upload & health check
    path("media/upload/", MediaUploadView.as_view(), name="media-upload"),
    path("media/health/", S3HealthCheckView.as_view(), name="media-health"),
