...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    can_create_project = models.BooleanField(default=True)
    can_assign_tasks = models.BooleanField(default=True)
...
class VerificationOTP(models.Model):
    ...
    purpose = models.CharField(max_length=20, choices=[('RESET', 'Password Reset'), ('VERIFY', 'Email Verification'), ('LOGIN', 'Login Verification')])
